import type { Edge, Node, NodeId } from "@/components/GraphCanvas";

export type { Edge, Node, NodeId };

export const edgeCsv = `NodeA,NodeB,Distance
1,2,20
2,27,5
2,L1_4,5
2,3,5
...
export const edges: Edge[] = edgeCsv
  .trim()
  .split("\n")
  .slice(1)
  .map((line) => {
...
export function dijkstra(edges: Edge[], start: NodeId, goal: NodeId): DijkstraResult {
